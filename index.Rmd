...
# source all R files to use in this index.Rmd file.
source('summary.R')
```
...
Idea: A line graph showing how prison population for different racial groups
changed over time.
...
Idea: A scatter plot showing the percentages of female vs male in prison.
...
Idea: A map of how the race/gender that is the most likely to be incarcerated
is distributed across the country (or maybe only Washington).
